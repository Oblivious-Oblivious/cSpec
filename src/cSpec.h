...
#define __nassert_that_value(actual, expected) _BLOCK( \
...
#ifdef _C11
    /* If C11 is available, you can use generic assertions */
    /* Expand 2 nested _Generic calls and select the static
        function that will call the specific typed macro */
    #define _get_typed_assertion(actual, expected) _Generic((actual), \
    ...
    #define _get_typed_nassertion(actual, expected) _Generic((actual), \
        int: _Generic((expected), \
